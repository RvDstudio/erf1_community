      ...
      <div className="container mx-auto space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs text-[#BCBDC7] dark:text-gray-400">
            ...
            <ul className="mt-8 flex gap-6">
              <li>
                <a
                  className="text-[#BCBDC7] transition hover:opacity-75 dark:text-gray-200"
                  href="#"
                  rel="noreferrer"
                  target="_blank"
                >
        ...
        <p className="text-[#BCBDC7] text-xs dark:text-gray-400">
          &copy; 2025. <span className="text-[#6699cc]">Moduvo</span> All rights
          reserved.
        </p>
      </div>
    </footer>
